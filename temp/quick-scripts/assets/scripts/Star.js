...
cc._RF.push(module, '98030Lc5lBFfKW2OOd6H+9S', 'Star', __filename);
// scripts/Star.js
...
cc.Class({
    ...
    properties: {
        ...
        // 暂存 Game 对象的引用
        game: {
            default: null, serializable: false
        }
    },
    getPlayerDistance: function getPlayerDistance() {
        ...
        // 根据两点位置计算两点之间距离 
        var dist = cc.pDistance(this.node.position, playerPos);return dist;
    },
